...
def getModelValues(fileName, wordLength = 32, depth = 128, numRWPorts = 1,
                   numRPorts = 1, numWPorts = 1, debug = False, technology = None):
...
#   os.chdir(tempDir)
  ...
  cmd = '%s/cacti -infile %s.cfg' % (cactiDir, fileName)
  os.system(cmd)
