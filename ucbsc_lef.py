...
#    pinHeight = 0.136
  ...
  if find_executable('Milkyway') is None:
    print('[WARNING]: Milkyway command not found. Skip milkyway generation.')
    print('You can generate the milkyway library manually from LEF file.')
  else:
